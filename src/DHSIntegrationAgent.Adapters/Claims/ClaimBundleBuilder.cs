...
public sealed class ClaimBundleBuilder
{
    ...
    private static JsonNode? ConvertToType(JsonValue value, SchemaDataType targetType)
    {
        ...
        return targetType switch
        {
            ...
            SchemaDataType.DateTime => DateTimeOffset.TryParse(strVal, CultureInfo.InvariantCulture, DateTimeStyles.AssumeUniversal, out var dt) ? JsonValue.Create(dt.UtcDateTime.ToString("yyyy-MM-ddTHH:mm:ss.fff", CultureInfo.InvariantCulture)) : JsonValue.Create(strVal),
