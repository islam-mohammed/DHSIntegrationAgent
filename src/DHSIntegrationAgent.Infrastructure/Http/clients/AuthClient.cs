...
public sealed class AuthClient : IAuthClient
{
    ...
    private sealed record LoginResponse(bool Succeeded, int StatusCode, string Message, InnerLoginResponse? Data);
    private sealed record InnerLoginResponse(bool Succeeded, int StatusCode, string Message, LoginData? Data);
