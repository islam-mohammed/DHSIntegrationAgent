...
public static class BaselineDomainScanner
{
    public static IReadOnlyList<BaselineDomain> GetBaselineDomains() => new List<BaselineDomain>
    {
        ...
        new("Country", 5, "claimHeader.Nationality"),
        new("ClaimSubtype", 100, "claimHeader.claimSubtype"),
        new("BirthCountry", 101, "claimHeader.birthCountry"),
        new("BirthCity", 102, "claimHeader.birthCity"),
        new("AdmissionSpecialty", 103, "claimHeader.admissionSpecialty"),
        new("DischargeSpeciality", 104, "claimHeader.dischargeSpecialty"),
        new("EncounterAdmitSource", 105, "claimHeader.encounterAdmitSource"),
        new("ReAdmission", 106, "claimHeader.reAdmission"),
        new("IntendedLengthOfStay", 107, "claimHeader.lengthOfStay"),
