...
public static class BaselineDomainScanner
{
    public static IReadOnlyList<BaselineDomain> GetBaselineDomains() => new List<BaselineDomain>
    {
        ...
        new("ClaimSubtype", 38, "claimHeader.claimSubtype"),
        new("Department", 62, "claimHeader.department"),
        new("City", 6, "claimHeader.birthCity"),
        new("Specialty", 8, "claimHeader.admissionSpecialty"),
        new("Specialty", 8, "claimHeader.dischargeSpecialty"),
        new("DischargeDisposition", 49, "claimHeader.dischargeDisposition"),
        new("EncounterAdmitSource", 18, "claimHeader.encounterAdmitSource"),
        new("EncounterClass", 10, "claimHeader.encounterClass"),
        new("ReAdmission", 29, "claimHeader.reAdmission"),
        new("EmergencyArrivalCode", 85, "claimHeader.emergencyArrivalCode"),
        new("IntendedLengthOfStay", 86, "claimHeader.intendedLengthOfStay"),
        new("DispositionCode", 87, "claimHeader.dispositionCode"),
        new("InvestigationResult", 88, "claimHeader.investigationResult"),
        new("PatientOccupation", 89, "claimHeader.patientOccupation"),
        new("Country", 5, "claimHeader.birthCountry"),
        ...
        new("DiagnosisOnAdmission", 90, "diagnosisDetails.diagnosisOnAdmission"),
